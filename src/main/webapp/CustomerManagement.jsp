    ...
    <div class="menu">
        <ul>
            <li>
                ...
                <dl>
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/agent/my_orderlist.jsp',this)">查看订单</a></dt>
            ...
            <li>
                ...
                <dl>
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/book/book_table.jsp',this)">预定座位时间</a></dt>
                    <dt><a href="javascript:void(0)" onclick="menuCAClick('tgls/book/book_menu.jsp',this)">预定菜品</a></dt>
                </dl>
            </li>
            <li>
